...
- California, Colorado, Delaware, Florida, Georgia, Illinois, Iowa, Massachusetts, Michigan, Minnesota, New Jersey, New York, North Carolina, Ohio, Oklahoma, Pennsylvania, Rhode Island, South Carolina, Tennessee, Texas, Vermont, Virginia, and Washington currently carry deeper source-verified draft packs. New Jersey's pack uses official 2026 legislature search/API results for AI data-center energy, automated-decision, and public-sector generative-AI bills. Illinois's pack uses official 104th General Assembly search/API results and bill pages for SB315, SB316, and HB35. The newest six packs use official state legislature bill/search, legislator lookup, committee/calendar, and public participation routes. Hawaii remains in the high-priority queue because the official Hawaii Legislature site blocks automated source retrieval and needs browser/manual verification before promotion. Wisconsin also remains queued because its official legislature routes were not retrievable in this pass.
