...
- Alabama, Alaska, Arizona, Arkansas, California, Colorado, Connecticut, Delaware, Florida, Georgia, Illinois, Iowa, Kansas, Kentucky, Louisiana, Maine, Maryland, Massachusetts, Michigan, Minnesota, Mississippi, Missouri, Montana, Nebraska, Nevada, New Hampshire, New Jersey, New Mexico, New York, North Carolina, North Dakota, Ohio, Oklahoma, Oregon, Pennsylvania, Rhode Island, South Carolina, South Dakota, Tennessee, Texas, Utah, Vermont, Virginia, Washington, and West Virginia currently carry deeper source-verified draft packs. New Jersey's pack uses official 2026 legislature search/API results for AI data-center energy, automated-decision, and public-sector generative-AI bills. Illinois's pack uses official 104th General Assembly search/API results and bill pages for SB315, SB316, and HB35. The newest fourteen packs use official state legislature bill/search, legislator lookup, committee/calendar, hearing, public participation, and implementation routes to turn enacted-law states into implementation-pressure actions. Hawaii remains in the high-priority queue because the official Hawaii Legislature site blocks automated source retrieval and needs browser/manual verification before promotion. Idaho official routes also need manual verification after automated fetch blocks. Indiana official routes render as a JavaScript app in automated fetch. Wisconsin official legislature routes were not retrievable in this pass. Wyoming official routes still need browser/manual verification. The remaining baseline states are Hawaii, Idaho, Indiana, Wisconsin, and Wyoming.
